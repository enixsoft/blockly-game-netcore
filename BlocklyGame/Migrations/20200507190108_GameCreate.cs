        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<int>(nullable: false),
                    Level = table.Column<int>(nullable: false),
                    LevelStart = table.Column<string>(nullable: true),
                    Task = table.Column<int>(nullable: false),
                    TaskStart = table.Column<string>(nullable: true),
                    TaskEnd = table.Column<string>(nullable: true),
                    TaskElapsedTime = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Gameplay_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
